class JointView extends React.Component {
  ...
  componentDidMount = () => {
    ...
    loadMain(JointConstants.joints.scarfEndCut1, JointConstants.joints.scarfEndCut2, JointConstants.joints.scarfCenterCut1, JointConstants.joints.scarfCenterCut2);
  }
